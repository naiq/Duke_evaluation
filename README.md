...
|Basel. + LSRO   | 67.68% | 47.13%| "[Unlabeled Samples Generated by GAN Improve the Person Re-identification Baseline in vitro](https://arxiv.org/abs/1701.07717)", Zheng Zhedong, Zheng Liang and Yang Yi, ICCV 2017|
...
|Verif + Identif | 68.9% | 49.3% | "[A Discriminatively Learned Cnn Embedding for Person Re-identification](https://arxiv.org/abs/1611.05666)",  Zheng, Zhedong, Liang Zheng, and Yi Yang, TOMM 2017. [[code]](https://github.com/layumi/2016_person_re-ID)| 
...
|Mid-level Representation | 80.43% | 63.88% | "[The Devil is in the Middle: Exploiting Mid-level Representations for Cross-Domain Instance Matching](https://arxiv.org/pdf/1711.08106.pdf)", Yu Qian, Chang Xiaobin, Song Yi-Zhe, Xiang Tao, Hospedales Timothy, arXiv:1711.08106| 
